...
def analyze_text(filename):
    """Calculate the numer of lines and characters in a file
    Args:
...
class TextAnalysisTests(unittest.TestCase):
    """Tests for thr ''analyze_text()'' function."""

    def setUp(self):
        """Fixture that creates a file for the methods to use."""
    ...
    def test_character_count(self):
        """Check that the characters count is correct."""
        self.assertEqual(analyze_text(self.filename)[1], 131)

    def test_no_such_file(self):
        """Check that the proper exception is thrown if file is missing."""
